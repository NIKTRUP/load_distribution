...
template <class T>
std::ostream& operator<<(std::ostream& os, const std::vector<std::vector<T>>& s) {
    bool first = true;
    for(auto& vec: s){
        if (first) {
            os << vec;
...
template <class T>
std::ostream& operator<<(std::ostream& os, const std::pair<std::vector<std::vector<T>>, std::vector<T>>& s) {
    bool first = true;
